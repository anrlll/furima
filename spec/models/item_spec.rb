...
RSpec.describe Item, type: :model do
  before do
    ...
    image_path = Rails.root.join('spec', 'fixtures', 'files', 'staff1.jpg') # テスト画像のパスを指定
    @item.image.attach(io: File.open(image_path), filename: 'staff1.jpg', content_type: 'image/jpeg')
  end
